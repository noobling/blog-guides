<template>
  ...
  >
    ...
    <path
      d="M138.2,349.2c-8.5,0.1-16.9-1.4-24.8-4.4c-7.1-2.8-13.4-7.1-18.6-12.6c-5.3-5.7-9.3-12.5-11.8-19.9
    ...
    />
    <path
      d="M221.1,325.5H258v-73.9h-39.3v-23.4H258v-19.6c-0.1-4.5,0.6-8.9,2-13.2c1.3-3.8,3.4-7.4,6.2-10.3
	c3-3,6.6-5.3,10.6-6.8c4.8-1.7,9.9-2.6,15.1-2.5h40.7v23.4H288v29h44.6v23.4H288v73.9h39.3v23.4H221.1V325.5z"
      fill="#ffffff"
    />
    <path
      d="M418.8,349.2c-8.5,0.1-16.9-1.4-24.8-4.4c-7.1-2.8-13.4-7.1-18.6-12.6c-5.2-5.7-9.2-12.5-11.7-19.9
